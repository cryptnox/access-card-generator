...
`access-card-generator` is distributed under a dual-licensing model:
...
For standard usage through embedding or linking, the LGPLv3 terms generally permit integration into proprietary software, provided all conditions of the license are strictly met.
...
- Use of `access-card-generator` without any obligation imposed by the LGPLv3  
...
|------------------------|-------------------------------------------------------------|----------------------------------------------|
| **LGPLv3**             | Integration via standard embedding or linking, including proprietary software | Compliance with all LGPLv3 terms             |
